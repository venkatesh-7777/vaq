            ...
            {items.map((item, index) => (
              ...
              >
                <a
                  ...
                  className="outline-none py-[0.6em] px-[1em] inline-block text-white/80 hover:text-white transition-colors duration-300 font-medium uppercase tracking-wide text-sm"
                >
                  {item.label}
                </a>
              </li>
